...
function getDefaultEnrichments(locale = "de") {
    ...
    return [
        {
            id: "smart",
            name: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$i18n$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["t"])(messages, "enrichment.smart"),
            icon: "Sparkles",
            prompt: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$i18n$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["t"])(messages, "enrichment.prompt.smart")
        },
        {
            id: "tasks",
            name: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$i18n$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["t"])(messages, "enrichment.tasks"),
            icon: "ListChecks",
            prompt: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$i18n$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["t"])(messages, "enrichment.prompt.tasks")
        },
        {
            id: "meeting",
            name: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$i18n$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["t"])(messages, "enrichment.meeting"),
            icon: "NotebookPen",
            prompt: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$i18n$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["t"])(messages, "enrichment.prompt.meeting")
        },
        {
            id: "email",
            name: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$i18n$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["t"])(messages, "enrichment.email"),
            icon: "Mail",
...
async function transcribeAudio(blob, settings) {
    ...
    if (settings.privacy.offline) {
        throw new Error((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$i18n$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["t"])(messages, "errors.offlineMode"));
    }
    if (settings.api.whisper.provider === "Local") {
        throw new Error((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$i18n$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["t"])(messages, "errors.localTranscription"));
    }
    if (settings.api.whisper.provider === "Other" && !settings.api.whisper.endpoint.trim()) {
        throw new Error((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$i18n$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["t"])(messages, "errors.customWhisperEndpointRequired"));
    }
    if (!settings.api.whisper.apiKey) {
        throw new Error((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$i18n$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["t"])(messages, "errors.missingWhisperKey"));
    }
    if (blob.size > MAX_AUDIO_BYTES) {
        throw new Error((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$i18n$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["t"])(messages, "errors.audioTooLarge"));
    }
...
async function enrichTranscript(transcript, prompt, settings) {
    const messages = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$i18n$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getMessages"])(settings.general.language);
    if (!transcript.trim()) {
        throw new Error((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$i18n$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["t"])(messages, "errors.noTranscript"));
    }
    if (settings.privacy.offline) {
        throw new Error((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$i18n$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["t"])(messages, "errors.offlineMode"));
    }
    if (settings.api.llm.provider === "Local") {
        throw new Error((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$i18n$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["t"])(messages, "errors.localLlm"));
    }
    if (!settings.api.llm.apiKey) {
        throw new Error((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$i18n$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["t"])(messages, "errors.missingLlmKey"));
    }
    if (settings.api.llm.provider !== "OpenAI" && !settings.api.llm.baseUrl.trim()) {
        throw new Error((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$i18n$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["t"])(messages, "errors.baseUrlRequired"));
    }
    const endpoint = resolveEndpoint(settings.api.llm.baseUrl, "/v1/responses");
...
async function readFromTauri(filename) {
    if (!isTauri()) return null;
    try {
        const { readTextFile, exists, BaseDirectory } = await __turbopack_context__.A("[project]/node_modules/.pnpm/@tauri-apps+plugin-fs@2.4.5/node_modules/@tauri-apps/plugin-fs/dist-js/index.js [app-client] (ecmascript, async loader)");
...
function localizeError(message, locale) {
    ...
    return key ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$i18n$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["t"])(messages, key) : message;
}
...
function AppStoreProvider({ children }) {
        ...
        "AppStoreProvider.useEffect": ()=>{
            ...
            const load = {
                "AppStoreProvider.useEffect.load": async ()=>{
                    const localSettingsKey = ("TURBOPACK compile-time truthy", 1) ? localStorage.getItem(SETTINGS_KEY) : "TURBOPACK unreachable";
                    ...
                    const resolvedSource = tauriSettingsRaw ? "tauri" : localSettingsKey ? "local" : "default";
    ...
    const buildErrorDetails = (stage, settingsSnapshot, message)=>{
        const messages = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$i18n$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getMessages"])(settingsSnapshot.general.language);
        const stageLabel = stage === "transcribing" ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$i18n$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["t"])(messages, "steps.transcribing") : (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$i18n$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["t"])(messages, "steps.enriching");
        const lines = [
            `${(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$i18n$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["t"])(messages, "errorDetails.stage")}: ${stageLabel}`,
            `${(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$i18n$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["t"])(messages, "errorDetails.whisperProvider")}: ${settingsSnapshot.api.whisper.provider}`,
            `${(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$i18n$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["t"])(messages, "errorDetails.llmProvider")}: ${settingsSnapshot.api.llm.provider}`
        ];
        if (stage === "transcribing") {
            lines.push(`${(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$i18n$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["t"])(messages, "errorDetails.whisperEndpoint")}: ${settingsSnapshot.api.whisper.endpoint || "default"}`);
        } else {
            lines.push(`${(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$i18n$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["t"])(messages, "errorDetails.llmBaseUrl")}: ${settingsSnapshot.api.llm.baseUrl || "default"}`);
        }
        lines.push(`${(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$i18n$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["t"])(messages, "errorDetails.message")}: ${message}`);
        return lines.join("\n");
    };
    ...
    const processAudio = async (sessionId, blob, durationSec)=>{
        ...
        try {
            ...
            const fallback = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$i18n$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["t"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$i18n$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getMessages"])(locale), "errors.transcriptionFailed");
        ...
        try {
            const { enriched, keywords } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$processing$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["enrichTranscript"])(transcript, template?.prompt || "", settingsSnapshot);
            updateSession(sessionId, {
                status: "done",
                stage: undefined,
                enriched,
            ...
            const locale = settingsSnapshot.general.language;
            const fallback = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$i18n$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["t"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$i18n$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getMessages"])(locale), "errors.enrichmentFailed");
            const message = error instanceof Error ? localizeError(error.message, locale) : fallback;
            updateSession(sessionId, {
                status: "error",
                stage: undefined,
        ...
        retryProcessing: async ()=>{
            ...
            if (!blob) {
                ...
                updateSession(active.id, {
                    ...
                    errorDetails: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$i18n$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["t"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$i18n$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getMessages"])(locale), "errors.audioBlobMissingDetails")
                });
                return;
            }
...
//# sourceMappingURL=_82eded52._.js.map